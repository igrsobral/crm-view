    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="p-6" v-if="activities.length === 0">
            <div class="text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Start logging activities to see them here.</p>
            </div>
        </div>

        <div class="divide-y divide-gray-200 dark:divide-gray-700" v-else>
            <div v-for="activity in activities" :key="activity.id" class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <span v-if="activity.completed"
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300">
                                    Completed
                                </span>
                        ...
                        <p v-if="activity.description" class="mt-1 text-sm text-gray-600 dark:text-gray-300 line-clamp-2">
