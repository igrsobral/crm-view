<template>
  <div class="space-y-4">
    ...
    <div v-else-if="activities?.length === 0" class="text-center py-8">
      ...
      <button @click="$emit('activity-created')"
      ...
      <ul class="-mb-8">
        <li v-for="(activity, index) in activities" :key="activity.id">
          <div class="relative pb-8">
            <!-- Timeline line -->
            <span v-if="index !== activities.length - 1" class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200"
            ...
            <div class="relative flex space-x-3">
              ...
              <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                <div class="flex-1">
                  ...
                  <p v-if="activity.description" class="text-sm text-gray-600 mt-1 whitespace-pre-wrap">
                ...
                <!-- Activity Actions -->
                <div class="text-right text-sm whitespace-nowrap text-gray-500 flex items-start space-x-2">
                  <div>
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <button v-if="activity.scheduled_at" @click="toggleActivityCompletion(activity)"
                      ...
                      <svg v-if="activity.completed" class="h-4 w-4 text-green-600" fill="currentColor"
                        viewBox="0 0 20 20">
